<div class="bg-white position-relative pt-5">
    <div id="footer" class="px-md-5 px-2 py-md-5 py-4 position-relative bg-primary">
        <div class="row m-0">
            <div class="col-md-4">
                <img src="./assets/images/logo.png" alt="" class="img-fluid">
                <div class="content mt-3">
                    <p class="text-white w-75">We’re not in the business of 'maybe' — we’re in the business of hell yes. We help small businesses punch above their weight online with real, trackable ROI.</p>
                </div>
            </div>
            <div class="col-md-5 my-md-0 my-5">
                <h3 class="text-white text-uppercase fw-bold fs-26">get in touch</h3>
            ...
            <div class="col-md-2">
                <h3 class="text-white text-uppercase fw-bold fs-26">connect with us</h3>
                <div class="socials">
    ...
    <div class="border-top bg-primary">
            <div class="row m-0">
                <div class="col-md-12">
                    <p class="mb-0 text-center text-whiter fs-13 py-2">Copyright © 2025 BuzzByte Digital. All Rights Reserved.</p>
                </div>
            </div>
        </div>
</div>
